package com.test.persondemo.services;
...
public class UserRepositoryUserDetailsService implements UserDetailsService {
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		return this.users.findByUsername(username).map(ResolutionsUserSpringSecurityUserDetails::new)
				.orElseThrow(() -> new UsernameNotFoundException("username not found"));
	}

	private static class ResolutionsUserSpringSecurityUserDetails extends User
